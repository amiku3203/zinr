...
router.post('/link-restaurant', protect, subscriptionController.linkSubscriptionToRestaurant);
router.get('/restaurant/:restaurantId', protect, subscriptionController.getRestaurantSubscription);
