...
try {
  if (process.env.RAZORPAY_KEY_ID && process.env.RAZORPAY_KEY_SECRET) {
    ...
    logger.warn('Razorpay initialized with dummy credentials - payments will not work');
  }
} catch (error) {
...
const AVAILABLE_PLANS = {
  basic: {
    ...
    price: 999,
    duration: 30,
    features: ['Up to 100 orders/month', 'Basic menu management', 'QR code generation', 'Email support'],
    maxOrders: 100,
    maxMenuItems: 50
  },
  premium: {
    ...
    price: 1999,
    duration: 30,
    features: ['Unlimited orders', 'Advanced menu management', 'QR code generation', 'Priority support', 'Analytics dashboard'],
  ...
  enterprise: {
    ...
    price: 4999,
    duration: 30,
    features: ['Unlimited orders', 'Advanced menu management', 'QR code generation', '24/7 support', 'Advanced analytics', 'Custom branding'],
    maxOrders: -1,
    maxMenuItems: -1
  }
};
